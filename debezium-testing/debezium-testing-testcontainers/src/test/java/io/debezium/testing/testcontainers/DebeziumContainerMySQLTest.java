...
public class DebeziumContainerMySQLTest {
    ...
    public static MySQLContainer<?> mySQLContainer = new MySQLContainer<>("fastgql/mysql-testcontainers:latest")
            .withNetwork(network)
            .withUsername("debezium")
            .withPassword("dbz")
            .withNetworkAliases("mysql");

    public static DebeziumContainer debeziumContainer = new DebeziumContainer("1.0")
            .withNetwork(network)
    ...
    public static void startContainers() {
        Startables.deepStart(Stream.of(
                kafkaContainer, mySQLContainer, debeziumContainer)).join();
    }
    ...
    private Connection getConnection(JdbcDatabaseContainer<?> jdbcDatabaseContainer) throws SQLException {
        return DriverManager.getConnection(jdbcDatabaseContainer.getJdbcUrl(), jdbcDatabaseContainer.getUsername(),
    ...
    private ConnectorConfiguration getConfiguration(int id) {
        ...
        return ConnectorConfiguration.forJdbcContainer(mySQLContainer)
